...
<div class="detail">
  <header class="hero">
    ...
    {#if data.stravaUrl}
      <a class="strava" href={data.stravaUrl} rel="noopener noreferrer external" target="_blank">
        {i18n.t('detail.stravaLink')}
      </a>
    {/if}
  </header>

  <section class="tiles" aria-label={i18n.t('detail.tilesAriaLabel')}>
    {#if isNum(a.distanceM)}
      <StatTile
        label={i18n.t('detail.tile.distance')}
        value={fmtKm(a.distanceM, 2, i18n.locale)}
        unit="km"
        accent="orange"
      />
    {/if}
    <StatTile label={i18n.t('detail.tile.movingTime')} value={fmtDuration(elapsed)} accent="cyan" />
    {#if paceSport}
      <StatTile label={i18n.t('detail.tile.avgPace')} value={fmtPace(avgPace)} unit="min/km" accent="lime" />
    {:else}
      <StatTile
        label={i18n.t('detail.tile.avgSpeed')}
        value={fmtNum(speedKmh(avgSpeedMps), 1, i18n.locale)}
        unit="km/h"
        accent="lime"
      />
    {/if}
    {#if isNum(a.avgHr)}
      <StatTile
        label={i18n.t('detail.tile.avgHr')}
        value={fmtNum(a.avgHr, 0, i18n.locale)}
        unit="bpm"
        accent="red"
      />
    {/if}
    {#if data.power}
      <StatTile
        ...
        value={fmtNum(data.power.avg, 0, i18n.locale)}
        unit="W"
        accent="amber"
      />
    {/if}
    {#if isNum(a.elevationGainM)}
      <StatTile
        ...
        value={fmtNum(a.elevationGainM, 0, i18n.locale)}
        unit="m"
        accent="green"
      />
    {/if}
    {#if isNum(a.calories)}
      <StatTile
        label={i18n.t('detail.tile.calories')}
        value={fmtNum(a.calories, 0, i18n.locale)}
        unit="kcal"
        accent="violet"
      />
    {/if}
    {#if isNum(a.trainingLoad)}
      <StatTile
        label={i18n.t('detail.tile.load')}
        value={fmtNum(a.trainingLoad, 0, i18n.locale)}
        accent="indigo"
      />
    {/if}
  </section>
  ...
  {#if data.gps}
    <Card title={i18n.t('detail.mapTitle')}>
      <div class="map">
        <LeafletMap
          {polylines}
          {markers}
  ...
  {#if hasStreams}
    <Card title={i18n.t('detail.streamsTitle')} subtitle={i18n.t('detail.streamsSubtitle')}>
