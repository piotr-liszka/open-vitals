...
export interface IntensityMix {
  ...
  /** Sentence naming what the mix implies, in the reader's locale. */
...
function adviceFor(t: Translator): Record<MixVerdict, string> {
  return {
    'on-model': t('intensityMix.advice.onModel'),
    'too-hard': t('intensityMix.advice.tooHard'),
    'too-easy': t('intensityMix.advice.tooEasy'),
    unknown: t('intensityMix.advice.unknown')
  };
}
