...
export const pl = {
  ...
  'training.titleWithTab': 'Trening · {tab}',
  ...
  'readiness.basisDays': 'na podstawie {days} dni',

  'readiness.title': 'Gotowość',
  'readiness.subtitle': 'Jak bardzo jesteś dziś gotowy w porównaniu z Twoją ostatnią bazą',
