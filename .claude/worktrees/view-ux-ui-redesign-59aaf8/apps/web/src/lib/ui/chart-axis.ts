 ...
 * it is always kept) and keeping a candidate only once it clears `minGap` from the last one kept.
 * On an evenly spaced axis with every slot labelled this reduces to a constant index stride, i.e.
 * exactly what a dense date axis did before.
 */
