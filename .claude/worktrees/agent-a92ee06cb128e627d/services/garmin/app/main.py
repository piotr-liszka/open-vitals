...
class WorkoutCreateRequest(BaseModel):
    ...
    # spec 082: the workout-level description. Composed by the web tier (the
    # athlete's note plus one provenance line) and passed through verbatim — the
    # sidecar translates DTOs, it does not author content.
...
def create_app(
    ...
    def create_workout(
        ...
        try:
            return metrics.create_workout(
                user_id, body.sport, body.title, steps, body.note
            )
