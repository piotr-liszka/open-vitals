 ...
 * clock, random and consent service; no `Date.now()`, no `crypto` reached for directly.
 *
...
import { WORKOUT_WRITE_FEATURE } from '$lib/server/consent/registry';
...
export class WorkoutConsentError extends Error {}
...
async function requireWriteConsent(deps: WorkoutDeps): Promise<void> {
