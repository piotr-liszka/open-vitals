<script lang="ts">
  import { Button, StatTile, Sparkline, ThemeToggle } from '$lib/ui';
...
<div class="page">
  <header class="topbar">
    <span class="brand"><span class="dot" aria-hidden="true"></span> Vagus</span>
    <nav class="top-nav">
  ...
  <section class="band">
    <div class="features">
      <article>
        <h3><span class="marker" style="--m: var(--lane-orange)"></span>Tryb podstawowy</h3>
        <p>
      ...
      <article>
        <h3><span class="marker" style="--m: var(--lane-cyan)"></span>Tryb zaawansowany</h3>
        <p>
    ...
    <ol class="steps">
      ...
      <li>
        ...
        <div>
          ...
          <p>
            Włącz tryb zaawansowany, aby zobaczyć pulpit, albo podaj adres MCP asystentowi AI, by czytał Twoje
            metryki.
          </p>
        </div>
      </li>
...
$ make up                # web + sidecar + postgres</code
  ...
  <footer class="foot">
    <span><span class="dot" aria-hidden="true"></span> Vagus</span>
