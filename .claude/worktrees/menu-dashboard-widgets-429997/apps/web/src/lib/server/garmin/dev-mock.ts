  ...
  switch (name) {
    ...
    case 'training_readiness': {
      /*
        ...
        hours Garmin says remain until full recovery — occasionally 0, which must read as "ready"
        rather than as missing data, so the fixture reaches zero on some days.
      */
