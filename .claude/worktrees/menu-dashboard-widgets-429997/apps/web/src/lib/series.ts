 ...
 * say what one point means once the range stops being daily.
 */
export function bucketNoun(bucket: RangeBucket): string {
  switch (bucket) {
    case 'week':
      return 'tydzień';
    case 'month':
 ...
 */
export function bucketAxisLabel(day: DayKey, bucket: RangeBucket): string {
