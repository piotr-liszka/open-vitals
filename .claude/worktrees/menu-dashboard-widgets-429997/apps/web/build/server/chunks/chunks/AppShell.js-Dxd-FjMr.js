import { a4 as attr_class, ab as attr, a5 as escape_html, a6 as stringify, a7 as ensure_array_like, a8 as store_get, a9 as unsubscribe_stores, Q as derived, ac as attributes } from './index.js-D7taQuDv.js';
import { I as Icon } from './Icon.js-D5N4FEG5.js';
import { B as Button, S as Spinner } from './Button.js-B1j4uOxB.js';
import { T as ThemeToggle } from './ThemeToggle.js-T-urDE0b.js';
import { g as goto } from './client.js-C1MYAKQX.js';
import { p as page$1 } from './index2.js-DFeLIU8S.js';
import { S as SegmentedControl } from './SegmentedControl.js-vIk-Z1KL.js';
import { w as withRange, a as routeSupportsRange, b as RANGE_OPTIONS, p as parseRange, R as RANGE_PARAM, c as RANGE_PREF_KEY } from './range.js-VDtVJAwH.js';
import { p as page } from './stores.js-pwimOGzR.js';
...
function RangeSwitch($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const active = derived(() => parseRange(page$1.url.searchParams.get(RANGE_PARAM)));
    function navigate(key, replaceState) {
      const target = new URL(page$1.url);
...
function NavLinks($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const dashboards = derived(() => store_get($$store_subs ??= {}, "$page", page).data.dashboardNav ?? []);
    ...
    for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
      ...
      for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
        ...
        })}${attr("href", withRange(item.href, store_get($$store_subs ??= {}, "$page", page).url))}${attr("title", item.label)}${attr("aria-current", isActive(item.href, store_get($$store_subs ??= {}, "$page", page).url.pathname) ? "page" : void 0)}>`);
...
function AppShell($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const showRange = derived(() => range === "auto" && routeSupportsRange(page$1.url.pathname));
...
export { AppShell as A, IconButton as I, writeBoolPref as a, writePref as w };
//# sourceMappingURL=AppShell.js-Dxd-FjMr.js.map
