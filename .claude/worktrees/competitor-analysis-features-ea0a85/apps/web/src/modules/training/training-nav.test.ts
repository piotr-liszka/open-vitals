...
describe('training section navigation', () => {
  ...
  it('titles the shell per subpage', () => {
    ...
    expect(trainingTitle('/training/volume')).toBe('Trening · Objętość');
    expect(trainingTitle('/training/ride')).toBe('Trening · Rower');
    expect(trainingTitle('/training/walk')).toBe('Trening · Marsz');
    expect(trainingTitle('/training/goals')).toBe('Trening · Cele');
