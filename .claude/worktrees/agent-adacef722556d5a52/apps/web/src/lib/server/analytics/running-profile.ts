...
/** Standard race distances we surface personal bests for. */
export const RUN_DISTANCES: readonly RunDistance[] = [
 ...
 */
export function personalBests(runs: readonly RunSummary[]): RunningBest[] {
