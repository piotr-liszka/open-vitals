...
<div class="page">
  ...
  >
    <p class="intro">
      Podaj datę i dyscyplinę, a odliczanie, faza przygotowań i trajektoria formy policzą się z danych, które
      już tu są. Cele bez docelowej formy też mają sens — dostaniesz odliczanie i fazę, tylko bez oceny „czy
      zdążę”.
    </p>
  ...
  {#if data.suggestions.length > 0}
    <Card title="Starty z kalendarza Garmin" subtitle="Już je synchronizujemy — jeden klik i stają się celem">
