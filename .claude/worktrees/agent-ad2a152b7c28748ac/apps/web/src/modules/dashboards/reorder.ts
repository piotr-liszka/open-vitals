/**
 * Reordering (spec 064). Pure, so the drag-and-drop layer only has to decide *from* and *to* — the
 * list surgery is testable without synthesising a single drag event, and the keyboard move buttons
 * and the mouse drag provably do the same thing because they call the same function.
 */
