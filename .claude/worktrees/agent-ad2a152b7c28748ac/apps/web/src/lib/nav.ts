...
/** The fixed part of the nav, in reading order. */
export function navItems(t: Translator): NavItem[] {
 ...
 */
export function navGroups(t: Translator, dashboards: readonly NavItem[] = []): NavGroup[] {
  const [start, ...rest] = navItems(t);
